...
const FixedButtons = () => {
  return (
    <div className="my-[10rem] fixed right-2 top-1/2 transform -translate-y-1/2 " style={{ zIndex: 1000 }}>
      <div className="flex flex-col">
        <Link to={"/counseling"}>

          <button
            className="bg-gray-800 text-white font-semibold text-xs tracking-wider px-4 py-16 whitespace-nowrap hover:bg-gray-700 transition-colors duration-200"
            style={{ writingMode: 'vertical-rl', textOrientation: 'mixed', padding: '10px' }}
          >
